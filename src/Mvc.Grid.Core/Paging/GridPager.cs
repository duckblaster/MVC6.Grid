...
namespace NonFactors.Mvc.Grid
{
    public class GridPager<T> : IGridPager<T>
    {
        ...
        public virtual Int32 CurrentPage
        {
            get
            {
                CurrentPageValue = Int32.TryParse(Grid.Query[Grid.Name + "-Page"], out int page) ? page : CurrentPageValue;
        ...
        public virtual Int32 RowsPerPage
        {
            get
            {
                RowsPerPageValue = Int32.TryParse(Grid.Query[Grid.Name + "-Rows"], out int rows) ? rows : RowsPerPageValue;
